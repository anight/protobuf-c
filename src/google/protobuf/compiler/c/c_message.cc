...
GenerateMessageDescriptor(io::Printer* printer) {
  ...
  "  .sizeof_message        = sizeof($classname$),\n"
  "  .n_fields              = $n_fields$,\n"
  "  .fields                = $lcclassname$__field_descriptors,\n"
  "  .fields_sorted_by_name = $lcclassname$__field_indices_by_name,\n"
  "  .n_field_ranges        = $n_ranges$,\n"
  "  .field_ranges          = $lcclassname$__number_ranges,\n"
  "  .message_init          = (ProtobufCMessageInit) $lcclassname$__init,\n"
  "};\n");
}
